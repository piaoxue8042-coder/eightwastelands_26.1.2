...
public abstract class AbstractGhostArtifactItem extends Item
        implements ICurioItem, IGhostArtifactItem {

    public AbstractGhostArtifactItem(Properties properties) {
        super(properties);
    }
